...
func _build() -> void:
	_p("fantasy", "Fantasy", "village",
		...
		["Wędrowny rycerz", "Łotrzyk", "Zielarka", "Bard", "Łowca bestii", "Były najemnik"],
	...
	_p("historyczny", "Historyczny", "old-town",
		...
		["Kupiec", "Oficer", "Uczony", "Szpieg", "Rzemieślnik", "Duchowny"],
	...
	_p("wspolczesny", "Współczesność", "city",
		...
		["Dziennikarz", "Detektyw", "Programista", "Lekarka", "Były policjant", "Prawniczka"],
	...
	_p("noir", "Kryminał / Noir", "city-night",
		...
		["Prywatny detektyw", "Znużony gliniarz", "Femme fatale", "Dziennikarz śledczy", "Drobny gangster", "Adwokat"],
	...
	_p("horror", "Groza / Horror", "dark",
		...
		["Ocalały", "Badacz zjawisk", "Ksiądz", "Pielęgniarka", "Sceptyk", "Miejscowy przewodnik"],
	...
	_p("scifi", "Science fiction", "station",
		...
		["Inżynier pokładowy", "Oficer nawigacyjny", "Medyk", "Sztuczna świadomość", "Najemnik", "Naukowiec"],
	...
	_p("cyberpunk", "Cyberpunk", "neon",
		...
		["Netrunner", "Najemnik z augmentacjami", "Fikser", "Riggerka", "Zbieg z korporacji", "Uliczny medyk"],
	...
	_p("postapo", "Postapokalipsa", "wasteland",
		...
		["Padlinożerca", "Karawaniarz", "Sanitariuszka", "Były żołnierz", "Radiowiec", "Przewodniczka po pustkowiu"],
	...
	_p("western", "Western", "frontier",
		...
		["Rewolwerowiec", "Szeryf", "Poszukiwacz", "Hazardzistka", "Łowca nagród", "Farmer"],
	...
	_p("steampunk", "Steampunk", "industrial",
		...
		["Wynalazca", "Mechanik", "Aeronauta", "Detektyw", "Przemytniczka", "Inżynier gildii"],
